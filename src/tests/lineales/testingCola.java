...
public class testingCola {
	...
	public static void testCola() {
		...
		System.out
				.println("Recupera frente espera 1 recupera: \t\t\t" + (((int) q1.obtenerInicio() == 1) ? sOk : sErr));

		System.out.print("Saca espera true : \t\t\t\t\t" + ((q1.sacar() == true) ? sOk : sErr));
		System.out.println("\t--> " + q1.toString());
		System.out.println("Recupera frente espera 2 recupera \t\t\t" + (((int) q1.obtenerInicio() == 2) ? sOk : sErr));
		System.out.print("Saca espera true: \t\t\t\t\t" + ((q1.sacar() == true) ? sOk : sErr));
		System.out.println("\t--> " + q1.toString());
		System.out
				.println("Recupera frente espera 3 recupera: \t\t\t" + (((int) q1.obtenerInicio() == 3) ? sOk : sErr));
		...
		while (!q1.esVacia()) {
			System.out.print("Saca " + q1.obtenerInicio() + " de cola espera true: \t\t\t\t"
		...
		System.out.println(
				"Recupera frente en cola vacia espera null: \t\t" + ((q1.obtenerInicio() == null) ? sOk : sErr));
		...
		System.out.println(
				"Saca " + q2.obtenerInicio() + " de cola espera true: \t\t\t\t" + ((q2.sacar() == true) ? sOk : sErr));
